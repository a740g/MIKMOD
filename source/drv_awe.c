...
static char aweDriverName[] = "Sound Blaster AWE\0with 4294967296 KB DRAM";
...
DRIVER drv_awe = {
    NULL,
    aweDriverName,
    "MikMod Sound Blaster AWE Driver v"DRIVER_VERSION" by a740g",
    AWE_IsThere,
    AWE_SampleLoad,
    AWE_SampleUnload,
    AWE_Init,
